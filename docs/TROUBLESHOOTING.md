...
```bash
curl -fsSL https://raw.githubusercontent.com/Solnest-AI/solnest-seo-aeo/main/requirements.txt \
...
For plugin installs, check `/plugin list` and reinstall `solnest-seo@solnest-ai`; subagents load from the plugin, not `~/.claude/agents/`.
